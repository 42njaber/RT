...
/*   Updated: 2018/10/27 02:39:03 by njaber           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					default_check_node(t_scene *scene, t_node *onode,
																	char **pos);
int					parse_config_node(t_scene *scene, t_node *onode,
																	char **pos);
int					parse_objlist_node(t_scene *scene, t_node *onode,
																	char **pos);
int					parse_spotlist_node(t_scene *scene, t_node *onode,
																	char **pos);
